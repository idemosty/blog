    ...
    <div class="col-md-8">
      <div class="input-group mb-3">
        ...
        <div class="input-group-append">
          <button class="" type="button" @click="searchTitle">Search</button>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      ...
      <button class="m-3" @click="removeAllTips">Remove All</button>
    </div>
    <div class="col-md-6">
      <div v-if="currentTip">
        <h4>Tip</h4>
        ...
        <router-link :to="'/tips/' + currentTip.id" class="badge badge-warning">
          Edit
        </router-link>
      </div>
      <div v-else>
